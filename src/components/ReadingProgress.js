...
export default function ReadingProgress() {
  ...
  return (<div
        ...
        className={`${scrollPercentage > 0 ? 'w-9 h-9 ' : 'w-0 h-0 opacity-0'} group cursor-pointer  hover:bg-black hover:bg-opacity-10 rounded-full flex justify-center items-center duration-200 transition-all`}
    >
