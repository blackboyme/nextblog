...
export default function Banner() {
    ...
    return (
        <div className="container h-96 mx-auto flex justify-center gap-5 p-6">
            ...
            <section className="flex-[0.45] bg-white rounded-lg flex items-stretch">
                <div className="relative flex-1">
                    <div className='z-40 absolute bottom-0 left-0 p-10'>
                        <div className=" text-gray-300">我的一天</div>
                        <div className=" text-white text-3xl">最近去了广西旅游...</div>
                    </div>
                    <img src="/ban.jpg" alt="bu" className="object-cover object-center h-full w-full rounded-lg" />
                </div>
            </section>
        </div>
    )
