    ...
    return (
        <>
            <div className='relative group'>
                ...
                <div id='navbar' className='absolute hidden group/title group-hover:block text-gray-500 top-full mt-4 rounded-xl w-96 h-[100px] bg-white hover:border-[#425aef] border-[1px] border-transparent'>
                    <div className='p-2'>
