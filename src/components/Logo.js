    ...
    return (
        <>
            <div className='relative group'>
                <div className='flex'>
                    <FontAwesomeIcon id='navIcon'  icon={faGripVertical} className='text-black p-2 mr-1 w-5 h-5 group-hover:bg-[#425aef] rounded-xl' />
                </div>
                ...
                '>
                    <div className='p-2'>
                        <div className='text-[12px] pl-1 group-hover/title:text-[#425aef]'>推荐</div>
